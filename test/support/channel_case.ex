defmodule TanphatGatewayApiWeb.ChannelCase do
  @moduledoc """
  ...
  by setting `use TanphatGatewayApiWeb.ChannelCase, async: true`, although
  ...
  using do
    quote do
      ...
      import TanphatGatewayApiWeb.ChannelCase
